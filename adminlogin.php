...
<body>
    ...
    <h1 class="lead text-center alert alert-warning">Welcome Admin Please Login to Continue!</h1>
    <form method="post" action="adminauth.php">
        <div class="card-body w-50 mx-auto border border-secondary rounded">
            <div class="form-group mt-3 mx-2">
                ...
                <span class="fw-bold">Enter AdminId:</span><input type="text" class="form-control" id="uname"
                    placeholder="Enter AdminId" name="username" required>
            </div>
